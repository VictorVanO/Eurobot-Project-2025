...
void ServoArms::init() {
    ...
    servo_x_axis.attach(40, x_axis_degree);
    servo_y_left_axis.attach(41, y_axis_degree);
    servo_y_right_axis.attach(42, y_axis_degree);
    servo_z_axis.attach(43, z_axis_degree);
    servo_r_axis.attach(44, r_axis_degree);
    clamp.attach(45);
